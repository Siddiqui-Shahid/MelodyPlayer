...
backimg=ImageTk.PhotoImage(Image.open(r"bg2.jpg"))
#Paned Window
...
global pause_img
global play_image
pause_img = ImageTk.PhotoImage(Image.open(r"pause.png"))
play_image=ImageTk.PhotoImage(Image.open(r'play.png'))
...
#prev button
prev_img=PhotoImage(file=r'prev.png')
...
vol_img=PhotoImage(file=r'vol.png')
...
#Repeat button
repeat_img=PhotoImage(file=r"repeat.png")
...
#Repeat button
repone_img=PhotoImage(file=r"rep_one.png")
